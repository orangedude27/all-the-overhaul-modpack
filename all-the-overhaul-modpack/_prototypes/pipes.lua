local function bob_pipepictures(pipe_type)
    return {
        straight_vertical_single = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-straight-vertical-single.png",
            priority = "extra-high",
            width = 80,
            height = 80,
            hr_version = {
        ...
        straight_vertical = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-straight-vertical.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        straight_vertical_window = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-straight-vertical-window.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        straight_horizontal_window = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-straight-horizontal-window.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        straight_horizontal = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-straight-horizontal.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        corner_up_right = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-corner-up-right.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        corner_up_left = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-corner-up-left.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        corner_down_right = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-corner-down-right.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        corner_down_left = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-corner-down-left.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        t_up = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-t-up.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        t_down = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-t-down.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        t_right = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-t-right.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        t_left = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-t-left.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        cross = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-cross.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        ending_up = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-ending-up.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        ending_down = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-ending-down.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        ending_right = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-ending-right.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        ending_left = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-ending-left.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        vertical_window_background = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-vertical-window-background.png",
            priority = "extra-high",
            width = 64,
            height = 64,
            hr_version = {
...
local function bob_pipetogroundpictures(pipe_type)
    return {
        up = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-to-ground-up.png",
            priority = "high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        down = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-to-ground-down.png",
            priority = "high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        left = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-to-ground-left.png",
            priority = "high",
            width = 64,
            height = 64,
            hr_version = {
        ...
        right = {
            filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-to-ground-right.png",
            priority = "high",
            width = 64,
            height = 64,
            hr_version = {
...
local function bob_pipecoverspictures(pipe_type)
    return {
        north = {
            layers = {
                {
                    filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-cover-north.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    hr_version = {
        ...
        east = {
            layers = {
                {
                    filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-cover-east.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    hr_version = {
        ...
        south = {
            layers = {
                {
                    filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-cover-south.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    hr_version = {
        ...
        west = {
            layers = {
                {
                    filename = "__all-the-overhaul-modpack__/graphics/pipe-" .. pipe_type .. "/pipe-cover-west.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    hr_version = {
