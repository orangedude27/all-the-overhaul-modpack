data:extend({
    ...
    },
    {
        ...
        results = {
            { type = "item", name = "highenergy-data-248", amount = 1 },
            { type = "item", name = "fi_energy_crystal_charged", amount_min = 1, amount_max = 1, probability = 0.99 },
            { type = "item", name = "nickel-electromagnet", amount_min = 1, amount_max = 1, probability = 0.75 },
    ...
    },
    {
        ...
        results = {
            ...
            { type = "item", name = "fi_plutonium239", amount_min = 1, amount_max = 1, probability = 0.99 },
        },
        energy_required = 8,
    ...
    },
    {
        ...
        results = {
            { type = "item", name = "fu_tech_sign", amount = 1 },
            { type = "fluid", name = "se-space-coolant-hot", amount = 10 },
        },
        energy_required = 20,
