...
local equipmentCategories = { "solar-equipment", "transport-shield", "battery-equipment", "defense-equipment", "generator-equipment", "el_train_equipment", "fi_train_equipment" }
...
equipment.add_categories_to_grid("kr-locomotive-grid", equipmentCategories)

-- Diesel Train
local loc2Grid = data.raw["equipment-grid"]["el_train_equipment_grid"]
loc2Grid.width = 9
loc2Grid.height = 6
equipment.add_categories_to_grid("el_train_equipment_grid", equipmentCategories)
...
loc3Grid.width = 12
loc3Grid.height = 6
equipment.add_categories_to_grid("kr-nuclear-locomotive-grid", equipmentCategories)
...
loc4Grid.width = 15
loc4Grid.height = 9
equipment.add_categories_to_grid("gr_magnet_train_pre_grid", equipmentCategories)
...
loc5Grid.width = 15
loc5Grid.height = 12
equipment.add_categories_to_grid("gr_magnet_train_grid", equipmentCategories)
...
equipment.add_categories_to_grid("kr-wagons-grid", equipmentCategories)
