...
loco2.removeIngredient("kr-basic-tech-card")
...
wagon2.removeIngredient("kr-basic-tech-card")
...
fluid2.removeIngredient("kr-basic-tech-card")
...
loco4.addIngredient("kr-advanced-tech-card")