...
recipe08:replace_ingredient("productivity-module-3", { "gr_circuit", 10 })
...
recipe09:replace_ingredient("processing-unit", { "gr_circuit", 15 })
...
recipe10:replace_ingredient("processing-unit", { "gr_circuit", 20 })
