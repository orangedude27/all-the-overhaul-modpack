...
Recipe("5d-centrifuge-05"):replace_ingredient("speed-module", { "fu_TIM", 40 })
-- 06
...
Recipe("5d-centrifuge-06"):replace_ingredient("productivity-module", { "fu_TIM", 50 })
-- 07
...
Recipe("5d-centrifuge-07"):replace_ingredient("speed-module-2", { "fu_TIM", 60 })
-- 08
...
Recipe("5d-centrifuge-08"):replace_ingredient("processing-unit", { "gr_circuit", 50 })
Recipe("5d-centrifuge-08"):replace_ingredient("productivity-module-2", { "fu_TIM", 60 })
-- 09
...
Recipe("5d-centrifuge-09"):replace_ingredient("processing-unit", { "gr_circuit", 60 })
Recipe("5d-centrifuge-09"):replace_ingredient("speed-module-3", { "fu_TIM", 80 })
-- 10
...
Recipe("5d-centrifuge-10"):replace_ingredient("processing-unit", { "gr_circuit", 80 })
