...
recipe04:add_ingredient({ "fi_glass", 10 })
...
recipe05:add_ingredient({ "fi_glass", 10 })
...
recipe06:add_ingredient({ "fi_glass", 10 })
...
recipe07:add_ingredient({ "fi_glass", 10 })
...
recipe08:add_ingredient({ "fi_glass", 10 })
recipe08:replace_ingredient("low-density-structure", { "se-aeroframe-bulkhead", 10 })
recipe08:replace_ingredient("advanced-circuit", { "gr_circuit", 10 })
...
recipe09:add_ingredient({ "fi_glass", 10 })
recipe09:replace_ingredient("low-density-structure", { "se-aeroframe-bulkhead", 10 })
recipe09:replace_ingredient("processing-unit", { "gr_circuit", 10 })
...
recipe10:add_ingredient({ "fi_glass", 10 })
recipe10:replace_ingredient("low-density-structure", { "se-aeroframe-bulkhead", 10 })
recipe10:replace_ingredient("processing-unit", { "gr_circuit", 10 })
