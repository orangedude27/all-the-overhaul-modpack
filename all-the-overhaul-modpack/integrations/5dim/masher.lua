...
recipe08:replace_ingredient("processing-unit", { "gr_circuit", 4 })
...
recipe09:replace_ingredient("processing-unit", { "gr_circuit", 4 })
...
recipe10:replace_ingredient("processing-unit", { "gr_circuit", 4 })
