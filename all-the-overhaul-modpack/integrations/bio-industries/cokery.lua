...
if mods["Bio_Industries"] then
    ...
    local layer1 = entity1.animation
    ...
    entity1.module_specification = nil
    entity1.icon = nil
    ...
    entity3.animation.layers[2].tint = { r = 0, g = 0.57, b = 0.74, a = 1 }
    ...
    recipe2.replaceIngredient("iron-beam", "steel-beam")
    ...
    recipe3.replaceIngredient("steel-beam", "titanium-plate")
    ...
    local woodPulpToCoalDustRecipe = atom.util.Recipe({
        ...
        icons = {
            ...
            atom.util.icon.createSmallIcon({ icon = "__Bio_Industries__/graphics/icons/woodpulp_64.png", icon_size = 64 })
        },
        enabled = false,
    ...
    local coalDustToCokeRecipe = atom.util.Recipe({
        ...
        category = "biofarm-mod-smelting",
        icons = {
            { icon = "__Krastorio2Assets__/icons/items-with-variations/coke/coke.png", icon_size = 64, icon_mipmaps = 4 },
