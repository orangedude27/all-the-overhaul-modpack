...
data:extend({
	-- Iron molten
	{
        ...
        name = "atom-tin-plate",
        icons = {
          { icon = "__bztin__/graphics/icons/tin-plate.png", icon_size = 64, icon_mipmaps = 3,},
...
data:extend({
	-- Iron enrichment
	{
        ...
        icons = {
          { icon = "__bztin__/graphics/icons/enriched-tin.png", icon_size = 64, },
...
data:extend({
	-- Iron ingot
	{
        ...
        icons = {
          { icon = "__bztin__/graphics/icons/tin-ingot.png", icon_size = 128, },
          { icon = "__bztin__/graphics/icons/enriched-tin.png", icon_size = 64,  scale=0.25, shift= {-8, -8}},
        },
        category = "casting",
        energy_required = 18,
        ingredients = {
...
data:extend({
	-- Iron enrichment
	{
        ...
        icons = {
          { icon = "__bztin__/graphics/icons/enriched-tin.png", icon_size = 64, },
          { icon = "__bztin__/graphics/icons/tin-ore.png", icon_size = 64,  scale=0.15, shift= {-8, -8}},
        },
        category = "fluid-filtration",
        energy_required = 5,
        ingredients = {
