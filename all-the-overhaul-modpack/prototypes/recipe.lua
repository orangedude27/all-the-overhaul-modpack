...
data:extend({
    {
        ...
        icons = {
            ...
            createSmallIcon({ icon = "__Krastorio2Assets__/icons/items-with-variations/coke/coke.png", icon_size = 64, icon_mipmaps = 4 })
        },
    ...
    },
    {
        ...
        icons = {
            { icon = "__Nylon__/graphics/icons/raw-graphite.png", icon_size = 128 },
            createSmallIcon({ icon = "__Bio_Industries__/graphics/icons/charcoal.png", icon_size = 64, icon_mipmaps = 4 })
        },
        category = "biofarm-mod-smelting",
        order = "d[graphite]",
        enabled = false,
    ...
    },
    {
        ...
        icons = {
            { icon = "__Nylon__/graphics/icons/raw-graphite.png", icon_size = 128 },
            createSmallIcon(atom.refining.config.coal.icons.dust)
        },
        category = "biofarm-mod-smelting",
        order = "d[graphite]",
        enabled = false,
        energy_required = 1.6,
        ingredients = { { atom.refining.config.coal.itemNames.dust, 2 } },
        results = { { "raw-graphite", 1 } },
    }
})
